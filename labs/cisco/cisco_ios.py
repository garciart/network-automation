...
class CiscoIOS(object):
    ...
    def set_scp_source_interface(self, child, reporter, eol, scp_interface_port, commit=True):
    ...
    def set_tftp_source_interface(self, child, reporter, eol, tftp_interface_port, commit=True):
